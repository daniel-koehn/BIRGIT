function [S,k,f] = fk_filter(d,dt,dx,L,vmin,vmax,gamma_sw);
...
filt = conv2(filt,H,'same');
%  
%  % apply fk-filter to data 
S = S.*filt;
 
 tmp = ifft2(ifftshift(S));
